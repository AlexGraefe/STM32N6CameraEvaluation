...
uint8_t secondary_pipe_buffer1[VENC_WIDTH * VENC_HEIGHT * 2] __NON_CACHEABLE __attribute__ ((aligned (32))) = {0}; // needs to be aligned on 32 bytes for DCMIPP output buffer
...
int main(void)
{
  ...
  img_addr = secondary_pipe_buffer1;
